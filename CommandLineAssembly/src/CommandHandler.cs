        ...
        if (commandTrimmed == "exit") {
            ...
            if (BombActive) {
                ...
                if (heldBombCommander != null) {
                    if (heldBombCommander.TimerComponent.IsUpdating) {
                        ...
                        LogError("The held bomb is already paused");
                    }
                } else {
                    LogWarning("Please hold the bomb that you wish to pause");
                }
            } else {
                LogError("Bomb not active, cannot pause a bomb");
            }
            ...
            if (BombActive) {
                ...
                if (heldBombCommander != null) {
                    if (!heldBombCommander.TimerComponent.IsUpdating) {
                        ...
                        LogError("The held bomb is not paused");
                    }
                } else {
                    LogWarning("Please hold the bomb you wish to pause");
                }
            } else {
                LogError("Bomb not active, cannot unpause a bomb");
            }
            ...
            if (BombActive) {
                ...
                if (heldBombCommander != null) {
                    ...
                    LogWarning("Please hold the bomb you wish to turn");
                }
            } else {
                LogError("Bomb not active, cannot turn bomb");
            }
            ...
            Log("\"Pause\" - pauses the currently held bomb (NOTE: this will disable leaderboards)");
            Log("\"Unpause\" - unpauses the currently held bomb (NOTE: this will disable leaderboards)");
            if (_isDebug) {
                LogWarning("\"Turn\" - turns the bomb to the opposite face");
                LogWarning("\"CheckActive\" - returns debugging info about the current bomb");
            }
        } else {
